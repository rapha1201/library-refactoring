...
class RegulaPrice(Price):
    ...
    def get_frequent_render_points(self, days_rented: int) -> int:
        return 1
...
class Book:
    ...
    def get_frequent_render_points(self, days_rented: int) -> int:
        return self.price_code.get_frequent_render_points(days_rented)
...
class Rental:
    ...
    def get_frequent_render_points(self) -> int:
        return self.book.get_frequent_render_points(self.days_rented)
...
class Client:
    ...
    def statement(self) -> str:
        ...
        for rental in self._rentals:
            ...
            frequent_renter_points += rental.get_frequent_render_points()
